package com.filmplanet.Security;

import com.filmplanet.Security.Filters.JwtAuthenticationFilter;
import com.filmplanet.Security.Filters.JwtAutherizationFilter;
import com.filmplanet.Security.Jwt.JwtUtils;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationManager authenticationManager) throws Exception{
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth->{
                    auth.requestMatchers("/login","/create-admin","/create-user","/categoria","/actores/**").permitAll();
